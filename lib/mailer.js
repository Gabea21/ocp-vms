...
export const sendResetPasswordEmail = ({ toUser, hash }) => {
	const message = {
		...
		to: toUser.email , // in production uncomment this
		// to: 'gabrielajram@gmail.com',
		subject: 'Cocoon Project - Reset Password',
		html: `
      <h3>Hello ${toUser.fName} </h3>
      <p>To reset your password please follow this link: <a target="_" href="${process.env.MAIN_DOMAIN}/auth/reset-password/${hash}">Reset Password Link</a></p>
      <p>Cheers,</p>
      <p>Cocoon Project Team</p>
    `
	};
