...
export default function MainDashCameras(props) {
    const { searchItem, mainCamera, setMainCamera } = props;
    ...
    const handleSelectCamera = (e,camera) => {
        e.preventDefault()
        console.log('ran',camera)
        ...
        <div className="flex flex-col mt-4">
                <div className="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    ...
                    <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200 overflow-x-auto max-h-[360px]">
                        {loadedCameras.filter((val) => {
                            ...
                            return <tr key={cam._id}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-center">
                                            {mainCamera?._id === cam._id  ? 
                                                <span  className="px-4 py-2 cursor-pointer inline-flex text-md leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                                    Selected
                                                </span>
                                            :<span onClick={(e) => handleSelectCamera(e,cam)} className="px-4 py-2 cursor-pointer inline-flex text-md leading-5 font-semibold rounded-full bg-green-300 hover:bg-green-500 text-green-800">
                                                Set Main 
                                            </span>}
                                            ...
                                            <div className="flex items-center justify-start">
                                                    {cam.vxg.rec === "off" ? (
                                                      <GiCctvCamera size={30} />
                                                        ...
                                                        <div className=" border-2 border-blue-500 bg-black flex flex-col justify-center items-center">
                                                            {/* <Link  href={`/app/cameras/${cam._id}`}> */}
