...
export default function MainDashWebrelays (props) {
      const {locationFilter,searchItem, mainWebrelay, setMainWebrelay} = props;
      ...
      const handleSelectWebRelay = (e,webrelay) => {
        e.preventDefault()
        setMainWebrelay(webrelay)
    }
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            ...
                            <tr key={webrelay._id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-left text-md font-medium">
                                    {mainWebrelay?._id === webrelay._id ? 
                                        <span  className="px-4 py-2 cursor-pointer inline-flex text-md leading-5 font-semibold rounded-full bg-green-300 text-green-800">
                                            Selected
                                        </span>
                                    :<span onClick={(e) => handleSelectWebRelay(e,webrelay)} className="px-4 py-2 cursor-pointer inline-flex text-md leading-5 font-semibold rounded-full bg-green-300 hover:bg-green-500 text-green-800">
                                     Set Main Control
                                    </span>}
                                </td>
